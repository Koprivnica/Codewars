...
Unlike English, Turkish does not have "teen"-suffixed numbers; e.g. 13 would be directly translated as "ten three" rather than
"thirteen" in English.
...
def get_turkish_number(num):
    if num in DIGIT_DICT:
        ...
        return f"{DIGIT_DICT[num - (num % 10)]} {DIGIT_DICT[num % 10]}"
    return DIGIT_DICT[num % 10]
